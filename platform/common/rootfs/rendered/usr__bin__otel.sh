...
start() {
    ...
    docker create -t -v /etc/sonic:/etc/sonic:ro -v /etc/localtime:/etc/localtime:ro -v /:/mnt/host:ro -v /tmp:/mnt/host/tmp:rw -v /var/tmp:/mnt/host/var/tmp:rw --pid=host --userns=host \
